...
$sqlQ = "SELECT r.*, c.username, c.email, c.location, c.building, c.house FROM orders as r LEFT JOIN customers as c ON c.id = r.customer_id WHERE r.id=?"; 
    ...
    <div class="col-12">
        <?php if(!empty($orderInfo)){ ?>
            ...
            <div class="row col-lg-12 ord-addr-info">
                ...
                <p><b>Buyer Name:</b> <?php echo $orderInfo['username']; ?></p>
                <p><b>Email:</b> <?php echo $orderInfo['email']; ?></p>
                <p><b>Location:</b> <?php echo $orderInfo['location']; ?></p>
                <p><b>Building:</b> <?php echo $orderInfo['building']; ?></p>
                 <p><b>House:</b> <?php echo $orderInfo['house']; ?></p>
            </div>
